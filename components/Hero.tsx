    ...
    <div className="@container">
      <div className="@[480px]:p-4">
        <div 
          ...
          role="img"
          aria-label="Kit de facas premium em ambiente de churrasco" 
          style={{
        ...
        >
          ...
          <div className="flex flex-col gap-6 max-w-2xl px-2 relative z-10">
            <div className="flex items-center justify-center gap-3">
               ...
               <span className="text-primary text-[10px] md:text-xs font-black uppercase tracking-[0.4em] drop-shadow-sm">Alta Cutelaria Premium</span>
            ...
            <h1 className="text-white text-[32px] md:text-5xl lg:text-7xl font-black leading-[1.1] tracking-tighter font-display drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]">
              Pare de sofrer com facas cegas.
              <span className="block bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent mt-2">Fatie qualquer carne</span> 
              <span className="block mt-1">como se fosse manteiga.</span>
            </h1>
            
            <div className="w-16 h-1 bg-primary/30 mx-auto rounded-full"></div>

            <h2 className="text-white/80 text-lg md:text-2xl font-bold leading-relaxed font-display max-w-lg mx-auto drop-shadow-md px-4">
              Tenha em mãos o Kit Profissional com fio de navalha que você só encontra nas melhores churrascarias.
            </h2>
          </div>
          ...
          <div className="flex flex-col items-center gap-6 w-full max-w-md mt-4 relative z-10">
            <div className="w-full bg-[#b22222] text-white rounded-2xl py-4 px-6 text-center shadow-[0_10px_30px_-10px_rgba(178,34,34,0.6)] border border-white/10">
               <div className="flex items-center justify-center gap-2 mb-1">
                 ...
                 <span className="text-[10px] font-black uppercase tracking-widest opacity-80">Últimas Unidades Disponíveis</span>
               </div>
               <p className="font-black text-sm md:text-base leading-tight uppercase">Restam apenas 4 unidades com frete grátis</p>
            </div>
            ...
            >
              ...
              <div className="flex flex-col items-center leading-none">
                <span className="text-xl md:text-2xl font-black uppercase tracking-widest">Quero Garantir meu Kit com Desconto</span>
                <span className="text-[10px] md:text-xs font-black opacity-80 uppercase tracking-tighter mt-2 italic">Garantir Oferta e Pagar na Entrega</span>
              </div>
            </button>
            
            <div className="flex items-center justify-center gap-6 text-white/50 text-[10px] font-black uppercase tracking-[0.2em] pt-2">
               <span className="flex items-center gap-2 border-r border-white/10 pr-6 last:border-0"><span className="material-symbols-outlined text-[16px] text-[#25D366]">verified</span> Pagamento na Entrega</span>
               ...
               <span className="flex items-center gap-2"><span className="material-symbols-outlined text-[16px] text-[#25D366]">stars</span> 7 Dias de Garantia</span>
            </div>
          </div>
        </div>
      </div>
